 ...
 */
    ...
    public abstract class FlatAbstractRealMatrix
         ...
         */
        protected FlatAbstractRealMatrix() {}

        /**
         * Create a new RealMatrix with the supplied rowDimension and column dimensions.
         *
         * @param rowDimension  the number of rows in the new matrix
         * @param columnDimension  the number of columns in the new matrix
         * @throws NotStrictlyPositiveException if rowDimension or column dimension is not positive
         */
        protected FlatAbstractRealMatrix(final int rowDimension,
        ...
        public void setSubMatrix(final double[][] subMatrix, final int row, final int column)
            ...
            MatrixUtils.checkRowIndex(this, row);// need to rewrite these later TODO
